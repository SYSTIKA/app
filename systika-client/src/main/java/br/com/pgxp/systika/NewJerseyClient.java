...
/**
 * Jersey REST client generated for REST resource:ArquivosFacadeREST [br.com.pgxp.systika.domain.arquivos]<br>
 * USAGE:
 * <pre>
...
public class NewJerseyClient {
    ...
    private static final String BASE_URI = "http://localhost:8080/SysTika/webresources";

    public NewJerseyClient() {
        com.sun.jersey.api.client.config.ClientConfig config = new com.sun.jersey.api.client.config.DefaultClientConfig();
        client = Client.create(config);
        webResource = client.resource(BASE_URI).path("br.com.pgxp.systika.domain.arquivos");
    }
