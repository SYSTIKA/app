...
/**
 * Jersey REST client generated for REST resource:ArquivosFacadeREST
 * [arquivos]<br>
 * USAGE:
 * <pre>
...
public class NewJerseyClient {
    ...
    private static final String BASE_URI = "http://localhost:8084/systika-server/webresources";

    public NewJerseyClient() {
        com.sun.jersey.api.client.config.ClientConfig config = new com.sun.jersey.api.client.config.DefaultClientConfig();
        client = Client.create(config);
        webResource = client.resource(BASE_URI).path("arquivos");
    }
